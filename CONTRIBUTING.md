...
Thanks for wanting to help. Skugga is a small project with a big goal: a browser that protects ordinary people by default, without spying on them. Every contribution counts, whether it is a bug report, a translation fix or a new feature.

## Ways to contribute

- **Report bugs** — open an issue with the bug template. Include your OS, Skugga version (Settings → About) and steps to reproduce.
