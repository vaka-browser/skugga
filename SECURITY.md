...
Skugga is a browser whose whole point is protecting people. Security reports are the most valuable contribution you can make.
...
- Which Skugga version and operating system you tested on.
...
- The password manager and Skugga Wallet (both are end-to-end encrypted on the device — anything that breaks that is critical).
